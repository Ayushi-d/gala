package com.master.design.gala.Utils;
...
import com.master.design.gala.BuildConfig;
...
public class CameraUtils {
    ...
    public static Uri getOutputMediaFileUri(Context context, File file) {
        return FileProvider.getUriForFile(context, context.getPackageName()+".com.vansuita.pickimage" + ".provider", file);
    }

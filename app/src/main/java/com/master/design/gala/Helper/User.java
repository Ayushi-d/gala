...
import com.master.design.gala.Utils.MyCommon;
...
public class User {
    ...
    public String getSelectedDateNew() {
        return sp.getString("date_new", null);
    }

    public void setSelectedDateNew(String date) {
        sp.edit().putString("date_new", date).apply();
    }

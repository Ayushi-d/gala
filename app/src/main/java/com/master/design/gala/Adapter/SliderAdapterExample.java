...
public class SliderAdapterExample extends
    ...
    public SliderAdapterExample(Context context,ArrayList<SliderItem> menu) {
...
//        if(sliderItem.getImgId()!=null)
//            viewHolder.imageViewBackground.setImageResource(sliderItem.getImgId());
        if(sliderItem.getImageUrl()!=null && !sliderItem.getImageUrl().equalsIgnoreCase(""))
